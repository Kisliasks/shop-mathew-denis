...
Route::get('/admin',\App\Http\Controllers\AdminController::class)->name('admin.admin');


Route::group(['prefix' => 'categories'], function() {

    Route::get('/all', \App\Http\Controllers\Category\IndexController::class)->name('category.index');
...
Route::group(['prefix' => 'tags'], function() {
    ...
    Route::get('/all', \App\Http\Controllers\Tag\IndexController::class)->name('tag.index');
...
Route::group(['prefix' => 'users'], function() {
    ...
    Route::get('/all', \App\Http\Controllers\User\IndexController::class)->name('user.index');
...
Route::group(['prefix' => 'colors'], function() {
    ...
    Route::get('/all', \App\Http\Controllers\Color\IndexController::class)->name('color.index');
...
Route::group(['prefix' => 'products'], function() {
    ...
    Route::get('/all', \App\Http\Controllers\Product\IndexController::class)->name('product.index');
...
Route::group(['prefix' => 'groups'], function() {
    ...
    Route::get('/all', \App\Http\Controllers\Group\IndexController::class)->name('group.index');
